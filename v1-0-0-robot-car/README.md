...
4. Find objects to track: To train your model, you need to find objects to track. You can use double-sided black circles on photo copy paper and cut them out. [../media/eyes-pdf.pdf](../media/eyes-pdf.pdf)   <img src="../media/eyes.png" width=200 />
